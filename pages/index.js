...
export default function Home({ publications }) {
  ...
  return (
    <div className="bg-white dark:bg-darker transition-all duration-150 ease-in-out">
      ...
      >
        <Head>
          <title>Jashim Uddin | Frontend Developer & Designer</title>
          <meta
            name="description"
            content="The portfolio of frontend developer and designer, Jashim Uddin"
          />
            ...
            <div className="container relative flex flex-col items-start justify-center flex-grow px-0 mx-auto md:px-20 lg:px-24 section">
              <div className="w-full">
                ...
                <p className="w-4/5 text-xl md:w-full">
                  Love to build new projects and solve new problems.
                </p>
                <button
            ...
            <div className="flex flex-col">
              ...
              <div className="flex flex-col-reverse items-start w-full md:flex-row">
                <div className="flex flex-col w-full md:pr-8 md:w-3/5">
                  <p className="text-lg">
                    Hi! I&apos;m Jashim and I&apos;m a Computer Science Student,
                    currently in my 2nd year.
                  </p>
                  <p className="text-lg">
                    I am doing my study and also I am learning programming. I am
                    making this website as my portfolio apply for HAW Hamburg.
                    Hopefully I will get the admission there.
                  </p>
            ...
            <div className="flex flex-col-reverse w-full md:flex-row">
              <div className="w-full mb-4 md:pl-0 md:mb-0">
                ...
                <p className="text-lg">
                  Email me at{" "}
                  <Link
                    href="mailto:jashimahmad@outlook.com"
                    className="underline-link"
                  >
                    jashimahmad@outlook.com
                  </Link>{" "}
